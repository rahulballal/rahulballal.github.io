...
- Evaluated commercial and open source LLM models to improve the spend on marketing initiatives. Saved ~100k AUD by leading the implementation of the commercial offering in favor of BYO.
- Presented multiple solution design papers in the architecture forum for cross organisation aligment.
- Led a working group of AI native software development enabling automation of solution discovery, REST API Testing and Browser testing automation.
- Mentored a team of 5 engineers for enterprise architecture and improving delivery velocity.
